...
class PersonalInfo:
	...
	def __init__(self,full_name : str , address : str, phone_number : str, email : str, position : str, rank : str, salary : str):
...
class Employee(ABC):
	...
	def __init__(self,full_name: str , address : str ,phone_number : str , email : str ,position : str , rank : str , salary : str)->None:
...
class Developer(Employee):
	...
	def __init__(self, id: int, full_name: str, address: str, phone_number: str,email: str, position: str, salary: str) -> None:
		"""
	    ...
	    """
		self.id = id
		super().__init__(full_name=full_name , address = address , email = email , salary = salary , phone_number = phone_number , position = position )
...
class Task:
	...
	def __init__(self,id:int,title:str,deadline:datetime,items: list[str],is_done:bool,in_progress : bool,related_project:str):
...
class Project:
	...
	def __init__(self, title: str, start_date: datetime, task_list: list[int], limit: int) -> None:
		"""
...
class QualityAssurance(Employee):
	...
	def ask_sick_leave(self,project_manager : ProjectManager , project : Project , employee : Employee , assignment_managager : AssignmentManager):
